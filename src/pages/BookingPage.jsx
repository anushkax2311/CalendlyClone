...
useEffect(() => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const endTime = selectedDate.hour(h).minute(m + event.duration_minutes).second(0).toISOString()
    ...
    navigate(`/book/${slug}/confirmed`, {
      state: {
        ...
        invitee: form,
        answers: (event?.questions || []).map(q => ({ question: q.label, answer: answers[q.id] || '' })).filter(a => a.answer),
      },
    })
  }
  ...
  for (let d = 1; d <= daysInMonth; d++) calCells.push(currentMonth.date(d))
        ...
        <div className="booking-left">
          ...
          <div className="booking-meta-list">
            <div className="booking-meta-item">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#637488" strokeWidth="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
              <span>{event?.duration_minutes} min</span>
            </div>
            {event?.location && (
              <div className="booking-meta-item">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#637488" strokeWidth="2"><path d="M15 10.5a3 3 0 1 1-6 0 3 3 0 0 1 6 0z"/><path d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 0 1 15 0z"/></svg>
                <span>{event?.location}</span>
              </div>
            )}
            {(event?.buffer_before > 0 || event?.buffer_after > 0) && (
              <div className="booking-meta-item">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#637488" strokeWidth="2"><circle cx="12" cy="12" r="10"/><path d="M12 6v6l4 2"/></svg>
                <span>
            ...
            {selectedDate && selectedSlot && (
              <div className="booking-meta-item selected-time">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#006bff" strokeWidth="2"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>
        ...
        <div className="booking-right">
            ...
            <div className="booking-calendar-panel">
              ...
              <div className="mini-calendar">
                <div className="cal-nav">
                  <button className="cal-nav-btn" onClick={() => setCurrentMonth(m => m.subtract(1,'month'))}
                ...
                <div className="cal-timezone">
                  <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#637488" strokeWidth="2"><circle cx="12" cy="12" r="10"/><line x1="2" y1="12" x2="22" y2="12"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg>
                  <span>{event?.host_timezone || 'India Standard Time'}</span>
                </div>
              </div>
              {/* Time slots */}
              {selectedDate && (
                          ...
                          <button key={slot.time}
                            ...
                            {selectedSlot === slot.time ? (
                              <div className="slot-confirm-row">
                                ...
                                <button className="btn-confirm-slot" onClick={e => { e.stopPropagation(); setStep('form') }}>Confirm</button>
                              </div>
          ...
          {step === 'form' && (
            <div className="booking-form-panel fade-in">
              ...
              <p className="form-time-display">{formatSlot(selectedSlot)} · {selectedDate.format('dddd, MMMM D, YYYY')}</p>
              ...
              <div className="booking-form">
                ...
                <p className="booking-notice">
                  By proceeding, you confirm that you have read and agree to our <a href="#">Terms of Use</a> and <a href="#">Privacy Notice</a>.
                </p>
              </div>
            </div>
          )}
